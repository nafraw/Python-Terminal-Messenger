...
if __name__ == '__main__':
    ...
    a = 3
    msg = f"{a}+b"
    Highlighter.set_format('format_1', color='green', back_color='on_red', style=['bold'])
    Highlighter.custom_format('format_1', msg)
    Highlighter.set_format('WARNING', color='green', back_color='on_red', style=['bold'])
